...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Trình tải kênh YouTube"))
        self.downloadSelectedVidsButton.setText(_translate("MainWindow", "Tải về"))
        self.chanUrlEdit.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>Đường dẫn video, playlist hoặc kênh Youtube</p></body></html>"))
        self.chanUrlEdit.setPlaceholderText(_translate("MainWindow", "Đường dẫn video, playlist hoặc kênh Youtube"))
        self.getVidListButton.setText(_translate("MainWindow", "Lấy danh sách"))
        self.menuFile.setTitle(_translate("MainWindow", "Tệp"))
        self.menuHelp.setTitle(_translate("MainWindow", "Trợ giúp"))
        self.actionFile.setText(_translate("MainWindow", "&Tệp"))
        self.actionFile.setToolTip(_translate("MainWindow", "Tệp"))
        self.actionExit.setText(_translate("MainWindow", "&Thoát"))
        self.actionExit.setShortcut(_translate("MainWindow", "Ctrl+Q"))
        self.actionSettings.setText(_translate("MainWindow", "&Cài đặt"))
        self.actionSettings.setToolTip(_translate("MainWindow", "Cài đặt"))
        self.actionSettings.setShortcut(_translate("MainWindow", "Ctrl+S"))
        self.actionAbout.setText(_translate("MainWindow", "Giới thiệu"))
        self.actionYoutube_login.setText(_translate("MainWindow", "Đăng nhập Youtube"))
        self.actionYoutube_login.setShortcut(_translate("MainWindow", "Ctrl+Shift+L"))
        self.actionDonate.setText(_translate("MainWindow", "Ủng hộ"))
        self.actionDonate.setToolTip(_translate("MainWindow", "Ủng hộ tác giả"))
